...
Status: Account-lifecycle implementation is in `codex/account-lifecycle` for review. Its migration was applied to the approved Supabase project on September 16, 2026; the app branch has not yet been deployed. Legal copy remains pending the owner's templates and counsel review.
