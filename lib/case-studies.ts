...
export const caseStudies: CaseStudy[] = [
  {
    ...
    quote: "We thought we were stuck in a 6-year deal. Turns out the vendor had been violating the terms of that deal the whole time. We just didn't know what to look for.",
    ...
    flaggedItems: [
      ...
      { item: "Unauthorized 'facility services' fee", issue: "No contractual basis — added in 2024", savings: 12000 },
    ],
  },
  {
    ...
    flaggedItems: [
      ...
      { item: "Unauthorized fuel surcharge", issue: "Added 2022, no contractual basis", savings: 50000 },
    ],
  },
  {
    ...
    subhead: "A precision-parts manufacturer almost auto-renewed a 5-year uniform contract that contained three predatory clauses they didn't know existed.",
    annualSavings: 67400,
