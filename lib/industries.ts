...
export const industries: Record<string, Industry> = {
  restaurants: {
    ...
    topPains: [
      ...
      { title: "Discretionary fuel and environmental fees", body: "Most contracts let vendors add surcharges 'at company discretion.' These can grow quietly until they total 8–12% of the bill — worth knowing about." },
    ],
  ...
  healthcare: {
    ...
    hero: "Linen contracts worth a closer look before renewal.",
    heroItalic: "Average savings: 32%.",
    ...
    faqs: [
      { q: "We have a multi-year master agreement — can we still get savings?", a: "Yes. Most master agreements have at least one billing detail that doesn't match the original contract within the first 12 months — above-cap escalators, surcharges that weren't in the contract, missed volume tiers, and so on. We find these for you." },
  ...
  manufacturing: {
    ...
    hero: "Long-term uniform contracts deserve a thorough review.",
    heroItalic: "Average savings: 26%.",
